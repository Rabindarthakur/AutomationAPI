    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passing_year', models.IntegerField(default=2022, validators=[django.core.validators.MinValueValidator(1984), API.models.max_value_current_year])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Gender', models.TextField(blank=True, choices=[('Male', 'Male'), ('Female', 'Femail')], max_length=20)),
